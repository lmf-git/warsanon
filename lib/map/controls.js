...
export function mousemove(event) {
    ...
    if (clicked) {
        ...
        newPosition.x += Math.floor(event.movementX / screen.availWidth * horizontalTileNum);
        newPosition.y += Math.floor(event.movementY / screen.availHeight * horizontalTileNum);
