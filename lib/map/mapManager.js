...
export default class MapManager {
    ...
    static bootstrap(setOverlay, setOffset) {
        ...
        setTimeout(() => {
            ...
            // const viewportCenteredOffsetX = MapConfig.viewport.width / 2;
            // const viewportCenteredOffsetY = MapConfig.viewport.height / 2;
            setOffset({ 
                x: 
    ...
    static calcChunk(cX, cY) {
        ...
        for (let i = 0; i < this.chunkSize; i++) {
            for (let j = 0; j < this.chunkSize; j++) {
                const x = (cX * this.chunkSize) - j;
                const y = (cY * this.chunkSize) + i;
