...
export default function InstagramIcon(props) {
    ...
    return (
        <SvgIcon className={props.className}>
            <svg version="1.1" id="Instagram" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
                <g>
                    <rect id="instagram-back" fill="#517EA3" width="128" height="128"/>
                    <path id="instagram-instagram" fillRule="evenodd" clipRule="evenodd" fill="#FFFFFF" d="M91.5703,58.4829h-6.2392
